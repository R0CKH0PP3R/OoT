...
# The difference with this script over the non-2px variant is that this one extends
# the montage and copies an additional 2px from the next image when slicing it up. 
